...
AbbaSeo uses [DataForSEO](https://dataforseo.com/?aff=255379) to fetch SEO data. It's a pay-as-you-go third-party service unaffiliated with AbbaSeo. You need an API key to connect AbbaSeo to it.
