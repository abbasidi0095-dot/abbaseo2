 ...
 * ------------------------------------------------------------------ */
const MARKUP = 1.28; // AbbaSeo's flat 28% premium over raw DataForSEO cost
...
// Raw DataForSEO per-call cost in USD (NOT including AbbaSeo's markup).
const RAW_COST_USD = {
  ...
  return (
    <article className="mx-auto max-w-4xl">
      ...
      <p className="mt-4 max-w-2xl text-base leading-7 text-[var(--color-brand-muted)]">
        Other SEO tools are too expensive. AbbaSeo grows with you.
      </p>
        ...
        <dl className="mt-5 divide-y divide-[var(--color-border-subtle)]">
          ...
          <div className="py-4 first:pt-0 last:pb-0">
            ...
            <dd className="mt-1.5 text-sm leading-6 text-[var(--color-brand-muted)]">
              ...
              need an active subscription in order to use AbbaSeo.
            </dd>
          </div>
        </dl>
      </section>
