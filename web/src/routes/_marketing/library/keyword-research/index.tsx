...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "The discovery half runs on sources you already have: customer conversations, Google's autocomplete and People Also Ask, and your Search Console. Quality SEO data (volume, difficulty, live SERPs) is difficult to get, which is why SaaS tools run $100/month and up. AbbaSeo is the most affordable option, starting at $10/month, and you can start for free.",
  },
  {
...
export const Route = createFileRoute("/_marketing/library/keyword-research/")({
  head: () =>
    buildPageSeo({
      ...
      description:
        "Eight practitioner plays that treat keyword research as demand discovery, sourced from real interviews with working SEOs, executable inside AbbaSeo.",
      path: PATH,
      titleSuffix: "AbbaSeo",
    }),
    ...
    <article className="mx-auto max-w-5xl">
      ...
      <section className="mt-12">
        ...
        <p className="mt-2 max-w-2xl text-sm leading-6 text-[var(--color-brand-muted)]">
          ...
          why the big suites run $100/month and up; AbbaSeo starts at $10/month,
