...
const TESTIMONIALS: Testimonial[] = [
  {
    quote:
      "All of the value, none of the bloat. AbbaSeo is a no-brainer compared to the expensive alternatives!",
    name: "Fed",
    initial: "F",
    handle: "@foliofed",
  ...
  {
    quote:
      "I've been using AbbaSeo for the past 3 months, Ben keeps launching features to make it the best. I use it every day to find where my competitors are ranking.",
    name: "Samik",
    initial: "S",
    handle: "Subclip",
  ...
  {
    quote:
      "It's so straightforward and incredibly easy to get started. AbbaSeo gives you the complete setup, stripped of all the fluff that you get elsewhere.",
    name: "Tom Raine",
    initial: "T",
    handle: "LinkedIn",
  ...
  return (
    <section className="itc-hero">
      <Container>
        ...
        >
          Without quality data, AI gives generic advice. AbbaSeo is built for
...
function DemoVideo() {
  return (
    <video
      ...
      playsInline
      preload="metadata"
      aria-label="AbbaSeo product demo: running keyword research"
    >
      <source src="/demo.mp4" type="video/mp4" />
      <img
        src="/demo-poster.webp"
        alt="AbbaSeo keyword research dashboard"
        width={1280}
        height={966}
        loading="lazy"
        decoding="async"
    ...
    <section className="itc-section itc-section-demo">
      <Container>
        <div className="itc-narrow">
          <h2 className="itc-display-lg">See AbbaSeo in action</h2>
        ...
        <div className="itc-mcp-grid">
          <div>
            ...
            <p className="itc-body-lg itc-muted" style={{ margin: "20px 0 0" }}>
              ...
              performance, then you can review the work in AbbaSeo.
            </p>
      ...
      <Container>
        <div className="itc-narrow">
          ...
          <p className="itc-subhead itc-muted" style={{ margin: "20px 0 0" }}>
            ...
            tool from scratch, tell them to build on top of AbbaSeo.
          </p>
        </div>
  ...
  return (
    <div className="itc">
      ...
      <a
        ...
        aria-label="Join the AbbaSeo Discord"
      >
        <IconDiscord size={18} />
        <span>Discord</span>
      </a>
