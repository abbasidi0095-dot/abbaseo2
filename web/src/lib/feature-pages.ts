...
export const featurePages = {
  keywordResearch: {
    ...
    imageAlt: "AbbaSeo keyword research dashboard",
    imageSrc:
    ...
    faqs: [
      {
        question: "What is AbbaSeo keyword research best for?",
        answer:
          "AbbaSeo is best for finding SEO keyword ideas, checking demand and difficulty, and turning those ideas into saved keywords you can revisit.",
      },
      {
        question: "Can I use AbbaSeo as a free keyword research tool?",
        answer:
          "Not unlimited: quality keyword data costs money everywhere, which is why the big SEO suites run $100/month and up. AbbaSeo is the most affordable option; you can start for free, and paid plans start at $10/month with usage credits included. It's also open source, so you can self-host with your own DataForSEO account.",
      },
      {
        question: "Does AbbaSeo show live search results?",
        answer:
  ...
  siteAudit: {
    ...
    imageAlt: "AbbaSeo site audit report",
    imageSrc:
    ...
    faqs: [
      {
        question: "What does the AbbaSeo site audit tool check?",
        answer:
      ...
      {
        question: "Is AbbaSeo a free SEO audit tool?",
        answer:
          "For smaller sites, yes: the free plan includes site audits up to 50 pages per crawl. Larger crawls need a paid plan, starting at $10/month. AbbaSeo is also open source and self-hostable.",
      },
      {
        question: "Who should use AbbaSeo Site Audit?",
        answer:
  ...
  backlinkChecker: {
    ...
    imageAlt: "AbbaSeo backlinks report",
    imageSrc:
    ...
    related: [
      ...
      { label: "Domain Overview", href: "/features/domain-overview" },
      { label: "AbbaSeo MCP", href: "/features/mcp" },
    ],
    faqs: [
      {
      ...
      {
        question: "Can I check competitor backlinks in AbbaSeo?",
        answer:
  ...
  domainOverview: {
    ...
    imageAlt: "AbbaSeo domain overview",
    imageSrc:
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          "AbbaSeo covers the core of the same report (estimated traffic, organic keywords, top keywords, and top pages) without a triple-digit monthly seat. AbbaSeo is open source, so you can self-host it, and the managed app is $10/month and includes usage credits.",
      },
      {
        question: "Can AbbaSeo help with competitor keyword analysis?",
        answer:
  ...
  rankTracking: {
    ...
    imageAlt: "AbbaSeo rank tracking table",
    imageSrc:
    ...
    differentiators: [
      ...
      "AbbaSeo can expose ranking data to AI agents through MCP.",
    ],
    related: [
      { label: "Keyword Clustering", href: "/docs/skills/keyword-clustering" },
      {
    ...
    faqs: [
      ...
      {
        question: "Does AbbaSeo track mobile and desktop rankings?",
        answer:
  ...
  savedKeywords: {
    ...
    imageAlt: "AbbaSeo saved keywords list",
    imageSrc:
  ...
  aiBrandVisibility: {
    ...
    imageAlt: "AbbaSeo AI brand visibility report",
    imageSrc:
    ...
    differentiators: [
      ...
      "AbbaSeo helps teams connect AI mention and citation research to concrete SEO planning.",
    ],
    related: [
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          "Traditional SEO focuses on rankings and pages. AbbaSeo's AI visibility workflow looks at mentions, cited pages, related prompts, and platform-level metrics from supported AI-search sources.",
      },
      {
  ...
  aiSearchPrompts: {
    ...
    imageAlt: "AbbaSeo prompt explorer",
    imageSrc:
    ...
    differentiators: [
      ...
      "AbbaSeo treats AI search as a research layer, not a replacement for SEO fundamentals.",
      "AbbaSeo MCP exposes keyword, SERP, domain, backlink, saved keyword, and rank-tracking tools to AI agents.",
    ],
    related: [
