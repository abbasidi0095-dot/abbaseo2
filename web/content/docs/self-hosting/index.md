---
title: "Self-Hosting AbbaSeo"
description: "Run AbbaSeo yourself with Docker or Cloudflare, bring your own DataForSEO API key, and pay only for what you use."
---

AbbaSeo is free and open source. Self-hosting means the app costs $0. You bring your own DataForSEO API key and pay DataForSEO directly for API usage.
...
AbbaSeo uses [DataForSEO](https://dataforseo.com/?aff=255379) to fetch SEO data. DataForSEO is a paid third-party service unaffiliated with AbbaSeo. You need an API key to connect AbbaSeo to it.
