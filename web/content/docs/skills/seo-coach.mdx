...
- Help you choose the next AbbaSeo Agent Skill based on your goal.
- Distinguish strategy questions from execution work.
- Explain when to use AbbaSeo MCP, web search, browser review, or local files.
...
- "What does AbbaSeo help my agent do?"
...
The coach can help before MCP is connected, but your agent needs [AbbaSeo MCP](/docs/mcp) for live keyword, SERP, domain, backlink, and saved keyword data.
