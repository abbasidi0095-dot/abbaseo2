---
title: "Set up AbbaSeo Agent Skills"
description: "Add AbbaSeo skill files to your AI agent after connecting AbbaSeo MCP."
---

AbbaSeo Agent Skills are separate files from AbbaSeo MCP.

First, [set up AbbaSeo MCP](/docs/mcp). MCP gives your agent access to AbbaSeo data.

Then add the AbbaSeo `SKILL.md` files you want your agent to use. Each skill gives your agent one SEO workflow.
...
### Option 2: Install all AbbaSeo skills

Use this if you want every AbbaSeo skill.
