---
title: "AbbaSeo Agent Skills"
description: "Add AbbaSeo Agent Skills to Claude Code, Codex, or another AI agent so it can run repeatable SEO workflows with live AbbaSeo data."
---

AbbaSeo Agent Skills let you hand repeatable SEO workflows to your AI agent.
...
You stay in charge of strategy. Your agent uses AbbaSeo data and the skill instructions to return a recommendation, plan, or shortlist.

## Set up AbbaSeo Agent Skills

1. [Set up AbbaSeo MCP](/docs/mcp).
2. [Set up AbbaSeo Agent Skills](/docs/skills/setup).

MCP connects your agent to AbbaSeo data. Skills tell your agent which SEO workflow to run.
...
AbbaSeo uses the same `SKILL.md` pattern supported by modern AI agents. To learn how skills work in your agent, read:
...
- [AbbaSeo Agent Skills on GitHub](https://github.com/every-app/open-seo/tree/main/.agents/skills)
