...
- Ask before saving keywords back to AbbaSeo.
...
- Confirm before saving selected keywords to AbbaSeo.

## Use it with AbbaSeo MCP

Set up [AbbaSeo MCP](/docs/mcp) so your agent can research live keyword metrics, inspect Google SERPs, check saved keywords, and save selected terms with your approval.
