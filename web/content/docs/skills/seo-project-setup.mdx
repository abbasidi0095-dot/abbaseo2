...
- Recommend the next AbbaSeo Agent Skill to run.
...
Set up [AbbaSeo MCP](/docs/mcp) so your agent can confirm the right AbbaSeo project and use live SEO data in later workflows.
