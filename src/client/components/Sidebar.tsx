  ...
  return (
    <div className="flex h-full w-60 flex-col bg-base-200">
      <div className="flex items-center justify-between px-3 pb-2 pt-3">
        ...
        >
          <span className="flex size-6 items-center justify-center rounded-md bg-gradient-to-br from-primary to-cyan text-[11px] font-bold text-white shadow-sm shadow-primary/30">
        ...
        <nav className="min-h-0 flex-1 overflow-y-auto px-2 py-2">
          {navGroups.map((group) => (
            <div key={group.label} className="mb-1">
              <div className="px-3 pb-1 pt-3 font-mono text-[10px] uppercase tracking-wider text-base-content/40">
                {group.label}
              </div>
