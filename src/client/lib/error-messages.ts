...
const STANDARD_MESSAGES: Record<ErrorCode, string> = {
  ...
  AUTH_CONFIG_MISSING:
    "AbbaSeo auth is not configured. Follow the README setup steps for Cloudflare Access.",
  PAYMENT_REQUIRED:
    "An active hosted subscription is required before you can use AbbaSeo.",
  ...
  DATAFORSEO_AUTH_FAILED:
    "DataForSEO rejected the credentials. Check the DataForSEO login and password in Settings.",
