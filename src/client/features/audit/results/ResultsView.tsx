...
import { AuditHealthPanel } from "@/client/features/audit/results/AuditHealthPanel";
import {
  ExportDropdown,
  PerformanceTable,
...
export function ResultsView({
  ...
  return (
    <>
        ...
        <div className="flex items-start gap-3 rounded-lg border border-warning/30 bg-warning/5 px-4 py-3 text-sm">
          ...
          <p>
            ...
            <span className="text-base-content/70">
              ...
              <code className="font-mono">AbbaSeo-Audit</code> user agent in
      ...
      <AuditHealthPanel
        issues={issues}
        onShowIssues={() => onTabChange("issues")}
      />
