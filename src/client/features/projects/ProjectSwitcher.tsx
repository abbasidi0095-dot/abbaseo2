  ...
  return (
    ...
    >
      <button
        ...
        className="flex w-full items-center justify-between gap-2 rounded-md border border-base-300 bg-base-100 px-3 py-1.5 text-left transition-colors hover:border-base-content/25 focus-visible:outline focus-visible:outline-primary"
      >
