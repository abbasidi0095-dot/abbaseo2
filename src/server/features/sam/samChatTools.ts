 ...
 * free site-reading tools. Every tool the AbbaSeo MCP server exposes is
...
export function buildSamMcpTools(
  ...
  return {
    ...
    get_product_info: tool({
      description:
        "The AbbaSeo fact sheet: what the product does, plans/pricing, credit costs, integrations, MCP setup. Call before answering questions about AbbaSeo itself. Uses no credits.",
      inputSchema: z.object({}),
