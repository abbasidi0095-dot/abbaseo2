# AbbaSeo review context

## Review posture

AbbaSeo receives external contributions, including untested coding-agent output. Treat changed behavior as untrusted until the relevant call path and tests support it.
