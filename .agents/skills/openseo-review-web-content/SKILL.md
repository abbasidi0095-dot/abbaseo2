...
description: Write and review content for the AbbaSeo website (web/) — blog posts, guides, feature pages, FAQs. Distills the philosophy for on-brand, useful, accurate content. Use whenever adding or editing user-facing prose in web/content or web/src.
metadata:
  internal: true
---
...
3. **Honest pricing, with its reasoning.** Quality SEO data is expensive everywhere — that's why the big suites run $100/month and up. AbbaSeo is the affordable option: $10/month, free to start. Never simply "free."
...
- If a reader trusted every claim and screenshot, then opened AbbaSeo right now, where would reality not match?
