...
# AbbaSeo Keyword Research

## Goal

Turn seed topics into a prioritized keyword opportunity set using AbbaSeo MCP data. The output should help the user decide what to target, what to save, and what to research next.
...
- Do not invent metrics. If AbbaSeo does not return a value, write `unknown`.
