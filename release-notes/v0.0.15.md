...
> [!NOTE]
> AbbaSeo now includes agent skills for guided SEO workflows. See [AbbaSeo Skills](../README.md#openseo-skills) for setup and available skills.

## What's new

- Add AbbaSeo agent skills for:
  - Keyword Research
  - Keyword Clustering
  - Competitor Analysis
  - Link Prospecting
