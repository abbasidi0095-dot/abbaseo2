🚀 AbbaSeo now supports MCP, so you can use AbbaSeo as the SEO brain for your Claude Code, Codex, or AI agent workflows.

Connect your agent to AbbaSeo and let it research with your live project data instead of starting from a blank chat.
...
- Ask an agent to research keyword ideas for a domain and save the best ones to AbbaSeo.
...
- Use AbbaSeo with Claude Desktop, Claude Code, Codex, or any MCP-compatible AI tool.
